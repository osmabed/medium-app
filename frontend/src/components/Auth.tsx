...
import { SignupInput } from "@osmabed/medium-common";
...
export const Auth = ({type}: {type:"signup" | "signin"}) => {
    ...
    return <div className="h-screen flex justify-center flex-col">
        ...
        {type === "signup" ?<LabelledInput label="Name" placeholder="Abed Osmani..." onChange={(e) => {
            setPostInputs(c => ({
                ...c,
                name: e.target.value
            }))
        ...
        <LabelledInput label="Username" placeholder="osmabed10@gmail.com" onChange={(e) => {
            setPostInputs(c => ({
                ...c,
